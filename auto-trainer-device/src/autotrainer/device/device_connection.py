...
class DeviceConnection(DeviceConnectionProtocol):
    ...
    def __init__(self,
        ...
        self._current_thread_watchdog_perf_c = -math.inf
    ...
    def watchdog_writer_perf_c(self) -> float:
        dev = self._device
        return -math.inf if dev is None else dev.writer_watchdog_perf_c
    ...
    def _run_connected(self) -> bool:
        ...
        while True:
            ...
            self._current_thread_watchdog_perf_c = perf_now
