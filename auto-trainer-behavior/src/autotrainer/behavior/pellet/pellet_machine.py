...
class PelletMachine(StateMachine):
    ...
    def _before_load_pellet(self, *, force: bool=False):
    ...
    def can_load_pellet(self, *, force: bool=False):
        ...
        can = (
            can_use
            and self._algorithm.can_load_pellet(pellet_state=self._state)
        ) or force
    ...
    def load_pellet(self, *, force: bool=True):
        """Load pellet"""
