...
class PresenceInCageAlarm(AlarmDetector[PresenceInCageAlarmConfig]):
    ...
    def _check_state(self) -> Optional[float]:
        ...
        cfg_missing_delay = cfg.tunnel_to_cage_presence_missing_delay
        #
        all_missed_delays = (

            self._p_started - load_cell.last_disengaged_perf_c,
            # detector started since long enough

            cfg_missing_delay - (perf_now - load_cell.last_disengaged_perf_c),
            # tunnel exited at least since missing delay threshold

            load_cell.last_engaged_perf_c - (perf_now - tun_pres_age),
            ...
            topcam.last_absence_start_perf_c - load_cell.last_disengaged_perf_c,
            ...
            # currently absent from topcam

            topcam.last_absence_start_perf_c - (perf_now - cfg_missing_delay),
