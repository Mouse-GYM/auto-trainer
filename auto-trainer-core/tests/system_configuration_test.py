...
from autotrainer.core import (
    ...
    CameraId,
    CameraConfiguration,
    Offset3DTuple, InferenceConfiguration
)
...
v0_expected_result_config = {
    ...
    "inference": {
        ...
        "is_enabled": True,
        "min_confidence_plot_threshold": InferenceConfiguration.min_confidence_plot_threshold,
        "min_confidence_presence_threshold": InferenceConfiguration.min_confidence_presence_threshold,
    },
    "behavior": {
        "pellet_delivery": {
            "is_enabled": True,
